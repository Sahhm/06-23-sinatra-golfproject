...
CONNECTION.execute("CREATE TABLE IF NOT EXISTS outings (id INTEGER PRIMARY KEY, course_id INTEGER, golfer_id INTEGER, front_9_score INTEGER, back_9_score INTEGER);")
